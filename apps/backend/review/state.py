...
def _compute_spec_hash(spec_dir: Path) -> str:
    """
    Compute a combined hash of spec.md and test_plan.json.
    Used to detect changes after approval.
    """
    spec_hash = _compute_file_hash(spec_dir / "spec.md")
    plan_hash = _compute_file_hash(spec_dir / "test_plan.json")
...
class ReviewState:
    ...
    def is_approval_valid(self, spec_dir: Path) -> bool:
        ...
        Returns False if:
        - Not approved
        - spec.md or test_plan.json changed since approval
        """
