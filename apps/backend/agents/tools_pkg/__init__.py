...
operations on pfactory data structures. These tools replace prompt-based
...
Usage:
    from pfactory_tools import create_magestic_ai_mcp_server, get_allowed_tools
    ...
    options = ClaudeAgentOptions(
        mcp_servers={"pfactory": mcp_server},
