...
Examples:
  # List all specs
  python pfactory/run.py --list

  # Run a specific spec (by number or full name)
  python pfactory/run.py --spec 001
  python pfactory/run.py --spec 001-initial-app

  # Workspace management (after build completes)
  python pfactory/run.py --spec 001 --merge     # Add build to your project
  python pfactory/run.py --spec 001 --review    # See what was built
  python pfactory/run.py --spec 001 --discard   # Delete build (with confirmation)

  # Advanced options
  python pfactory/run.py --spec 001 --direct       # Skip workspace isolation
  python pfactory/run.py --spec 001 --isolated     # Force workspace isolation

  # Status checks
  python pfactory/run.py --spec 001 --review-status  # Check human review status
  python pfactory/run.py --spec 001 --qa-status      # Check QA validation status
...
def main() -> None:
    ...
    if not args.spec:
        ...
        print("\nUsage:")
        print("  python pfactory/run.py --list           # See all specs")
        print("  python pfactory/run.py --spec 001       # Run a spec")
