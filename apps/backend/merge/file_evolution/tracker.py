...
class FileEvolutionTracker:
    ...
    - File content snapshots in .pfactory/baselines/
    ...
    def __init__(
        ...
        Args:
            ...
            storage_dir: Directory for evolution data (default: .pfactory/)
        ...
        storage_dir = storage_dir or (self.project_dir / ".pfactory")
