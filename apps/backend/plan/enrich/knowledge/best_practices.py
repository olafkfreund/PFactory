...
_CATALOGUE: list[tuple[tuple[str, ...], KnowledgeRef]] = [
    ...
    (
        ("disaster", "dr", "failover", "rpo", "rto", "backup", "multi-region", "multi region"),
        KnowledgeRef(
            connector="best-practices",
            kind="best-practice",
    ...
    (
        ("redis", "elasticache", "kafka", "msk", "queue"),
        KnowledgeRef(
            connector="best-practices",
            kind="best-practice",
    ...
    (
        ("ci/cd", "cicd", "pipeline", "deploy", "helm"),
        KnowledgeRef(
            connector="best-practices",
            kind="best-practice",
    ...
    (
        ("microservice", "api", "service mesh", "networkpolicy"),
        KnowledgeRef(
            connector="best-practices",
            kind="best-practice",
