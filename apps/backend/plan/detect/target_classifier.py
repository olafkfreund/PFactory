...
_SOFTWARE_SIGNALS: dict[str, int] = {
    # strong
    "api": 2, "endpoint": 2, "microservice": 2, "database": 2, "schema": 2,
    "migration": 2, "kubernetes": 2, "docker": 2, "ci/cd": 2, "cicd": 2,
    "frontend": 2, "backend": 2, "rest": 2, "graphql": 2, "webhook": 2,
    "terraform": 2, "helm": 2, "openshift": 2, "sdk": 2, "repository": 2,
    "deploy": 2, "deployment": 2, "authentication": 2, "oauth": 2, "jwt": 2,
    "unit test": 2, "integration test": 2, "pull request": 2,
    # softer
    "service": 1, "server": 1, "function": 1, "module": 1, "library": 1,
    "cache": 1, "queue": 1, "latency": 1, "throughput": 1, "build": 1,
    "pipeline": 1, "code": 1, "feature": 1, "bug": 1, "refactor": 1,
    "react": 1, "python": 1, "typescript": 1, "golang": 1, "rust": 1,
    "config": 1, "environment": 1, "release": 1, "commit": 1, "branch": 1,
}
_NON_SOFTWARE_SIGNALS: dict[str, int] = {
    # strong
    "marketing campaign": 2, "hiring": 2, "recruit": 2, "recruiting": 2,
    "whitepaper": 2, "press release": 2, "legal": 2, "contract": 2,
    "procurement": 2, "budget": 2, "curriculum": 2, "syllabus": 2,
    "event planning": 2, "fundraising": 2, "brand": 2,
    # softer
    "policy": 1, "document": 1, "research": 1, "training": 1, "onboarding": 1,
    "blog": 1, "newsletter": 1, "survey": 1, "interview": 1, "workshop": 1,
    "presentation": 1, "report": 1, "proposal": 1, "stakeholder": 1,
}
