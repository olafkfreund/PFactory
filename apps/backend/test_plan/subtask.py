...
class Subtask:
    ...
    # PFactory lane tag (Task 3, #4; restructured v0.2 Task 0).
    ...
    # PFactory test-planning fields (Task 5, #6). The Planner agent
    ...
    target_name: str | None = None  # .pfactory.yml target name (or None)
    ...
    def to_dict(self) -> dict:
        ...
        # PFactory test-planning fields — always emit so the test_plan.json
