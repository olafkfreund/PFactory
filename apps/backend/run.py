...
Usage:
    ...
    python pfactory/run.py --spec 001 --merge     # Add completed build to project
    python pfactory/run.py --spec 001 --review    # See what was built
    python pfactory/run.py --spec 001 --discard   # Delete build (requires confirmation)
...
if sys.version_info < (3, 10):  # noqa: UP036
    sys.exit(
        f"Error: PFactory requires Python 3.10 or higher.\n"
