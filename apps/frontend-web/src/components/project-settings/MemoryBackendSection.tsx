...
export function MemoryBackendSection({
  ...
  const detectOllamaModels = useCallback(async () => {
    ...
    try {
      ...
      const statusResult = await window.API.checkOllamaStatus(ollamaBaseUrl);
      ...
      const modelsResult = await window.API.listOllamaEmbeddingModels(ollamaBaseUrl);
      ...
      {envConfig.graphitiEnabled && (
        <>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Name for the memory database (stored in ~/.pfactory/memories/)
            </p>
            <Input
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Custom storage location. Default: ~/.pfactory/memories/
            </p>
            <Input
              placeholder="~/.pfactory/memories"
