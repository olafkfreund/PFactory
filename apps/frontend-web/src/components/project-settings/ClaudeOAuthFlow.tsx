...
export function ClaudeOAuthFlow({ onSuccess, onCancel }: ClaudeOAuthFlowProps) {
  ...
  useEffect(() => {
    ...
    const unsubscribe = window.API.onTerminalOAuthToken((info) => {
  ...
  const handleStartAuth = async () => {
    ...
    try {
      ...
      if (!activeProfileId) {
        throw new Error('No active Claude profile found');
      }
      ...
      const result = await window.API.initializeClaudeProfile(activeProfileId);
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    PFactory requires Claude AI authentication for AI-powered features like
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-3 text-xs text-success/70">
                  ...
                  <span>You can now use all PFactory features</span>
                </div>
              </div>
            </div>
          </CardContent>
