...
# =============================================================================
# PRE-MOCK EXTERNAL SDK MODULES - Must happen BEFORE adding pfactory to path
# =============================================================================
...
@pytest.fixture
def test_plan_file(spec_dir: Path, sample_test_plan: dict) -> Path:
    """Create an test_plan.json file in the spec directory."""
    plan_file = spec_dir / "test_plan.json"
    plan_file.write_text(json.dumps(sample_test_plan, indent=2))
    return plan_file
...
def mock_spec_validator():
    ...
    def _create_mock(
        ...
        validator.validate_test_plan = MagicMock(return_value=plan_result)
...
CRITICAL_MODULES = frozenset(
    {
        ...
        "test_pfactory_yml_test_credentials",  # .pfactory.yml test_credentials schema (#107)
        ...
        "test_pfactory_yml_cloud_target",  # CloudProviderTarget schema (#133/#134)
